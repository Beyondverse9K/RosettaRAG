            ...
            <div className="max-w-3xl mx-auto relative">
                <div className="glass-input rounded-2xl flex items-end p-2">
                    <textarea
                        ...
                        className="flex-1 bg-transparent border-none px-4 py-3 text-slate-200 focus:outline-none focus:ring-0 resize-none max-h-32 min-h-[44px] overflow-y-auto placeholder:text-slate-500"
